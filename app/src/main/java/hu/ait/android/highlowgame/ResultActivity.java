...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra(GameActivity.KEY_NUMBER)){
            ...
            int numberOfGuessesItTook = getIntent().getIntExtra(GameActivity.KEY_GUESSES,0);
            tvResult.setText("Congratulations, the winner number is: "+winnerNumber+". It took you: "+numberOfGuessesItTook+" guesses. ");
